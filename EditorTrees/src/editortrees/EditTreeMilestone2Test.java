...
public class EditTreeMilestone2Test {
	...
	public void testComplexRotationsOnTreeFromSlides() {
		...
		System.out.println("[K8=, C2\\, A0\\, B0=, H3/, E1=, D0=, F0=, J0=, U7=, P3=, M1=, L0=, N0=, R1=, Q0=, S0=, W1\\, V0=, Y1/, X0=]");
	...
	public void testConstructorWithEditTree() {
		...
		System.out.println(t3s.toDebugString());
		...
		System.out.println(maxHeight(t2.size()));
